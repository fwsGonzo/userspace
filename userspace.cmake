...
option(SAN_ADDR     "Enable undefined- and address sanitizers" OFF)
option(SAN_MEM      "Enable undefined- and memory sanitizers" OFF)
...
if(SAN_ADDR AND SAN_MEM)
  message(FATAL_ERROR "Cannot enable both Address and Memory sanitizers at the same time!")
endif()
if(SAN_ADDR)
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fsanitize=undefined -fsanitize=address")
endif()
if(SAN_MEM)
  # Remember LD library path to LLVM lib folder if you are using a custom Clang!
  # Remember to enable LIBCPP option if you are using a custom Clang!
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fsanitize=undefined -fsanitize=memory")
endif()
if(PAYLOAD_MODE)
...
if (LIBCPP)
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -nostdinc++ -I${LIBCPP_PATH}/include/c++/v1")
  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -stdlib=libc++ -L${LIBCPP_PATH}/lib -lc++abi -Wl,-rpath,${LIBCPP_PATH}/lib")
endif()
...
# Userspace libraries
#
set(USPCPATH ${CMAKE_CURRENT_LIST_DIR})
set(IOSPATH ${USPCPATH}/repos/IncludeOS)

include_directories(${USPCPATH}/repos/GSL/include)
include_directories(${USPCPATH}/repos/rapidjson/include)
include_directories(${USPCPATH}/repos/IncludeOS/api)
include_directories(${USPCPATH}/repos/IncludeOS/src/include)

add_subdirectory(${USPCPATH}/src src)
if (BUILD_PLUGINS)
add_subdirectory(${USPCPATH}/src/plugins plugins)
endif()
